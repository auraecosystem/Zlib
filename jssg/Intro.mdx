...
<CardGroup cols={2}>
  <Card title="JSSG API reference" href="/jssg/reference" icon="book">
  ...
  <Card title="Semantic Analysis" href="/jssg/semantic-analysis" icon="magnifying-glass">
  ...
  <Card title="Metrics" href="/jssg/metrics" icon="chart-simple">
